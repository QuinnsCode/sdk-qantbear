// Generated by Wrangler by running `wrangler types` (hash: bcaa9e39c320173cb7fb66125f4827ae)
...
declare namespace Cloudflare {
	interface Env {
		...
		BOARD_GAME_DURABLE_OBJECT: DurableObjectNamespace<import("./src/worker").BoardGameDurableObject>;
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
