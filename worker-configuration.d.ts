// Generated by Wrangler by running `wrangler types` (hash: ad04e8f094a7f4db6eb4915a213bb888)
// Runtime types generated with workerd@1.20250320.0 2024-09-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		APP_NAME: "_rw-sdk-test-do";
		RP_ID: string;
		SECRET_KEY: string;
		TURNSTILE_SECRET_KEY: string;
		REALTIME_DURABLE_OBJECT: DurableObjectNamespace<import("./src/worker").RealtimeDurableObject>;
		NOTE_DURABLE_OBJECT: DurableObjectNamespace<import("./src/worker").NoteDurableObject>;
		GAME_DURABLE_OBJECT: DurableObjectNamespace<import("./src/worker").GameDurableObject>;
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
